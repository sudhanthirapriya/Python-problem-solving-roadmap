"""
Problem: Dynamic Class
Difficulty: Hard
Tags: #variables #data-types #hard #dynamic-programming

Description
-----------
Create a class dynamically with attribute x using type().
...
- Time yourself (aim for 20-30 minutes for hard)
